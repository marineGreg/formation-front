...
register_sidebar(
	array(
		'name'          => 'Région du logo',
		'id'            => 'region_du_logo',
		'description'   => 'Région du haut servant principalement pour le widget logo',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
register_sidebar(
	array(
		'name'          => 'Région du haut droit',
		'id'            => 'region_du_haut_droit',
		'description'   => 'Région du haut à droite servant principalement pour les petits widgets complémentaires',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
register_sidebar(
	array(
		'name'          => 'Sidebar gauche',
		'id'            => 'sidebar_gauche',
		'description'   => "Zone de gauche n'apparaissant que dans le corps du modele de page trois colonnes",
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
